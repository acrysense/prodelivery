  ...
  if (categoriesWrap && categoriesTrigger && categoriesClose) {
    categoriesTrigger.addEventListener('click', function (event) {
      ...
      if (categoriesWrap.classList.contains('is--active')) {
        ...
        categoriesWrap.style.top = categoriesTrigger.getBoundingClientRect().top + categoriesTrigger.getBoundingClientRect().height + 'px';
        categoriesWrap.style.maxHeight = 'calc(100dvh - ' + (categoriesTrigger.getBoundingClientRect().top + categoriesTrigger.getBoundingClientRect().height) + 'px)';
        categoriesWrap.querySelector('.categories__scroll').style.maxHeight = 'calc(100dvh - ' + (categoriesTrigger.getBoundingClientRect().top + categoriesTrigger.getBoundingClientRect().height) + 'px)';
        document.body.classList.add('scroll-disabled');
      }
    });
